...
const MarqueeText: React.FC = () => {
  ...
  const [marqueeDirection, setMarqueeDirection] = useState<"left" | "right">("right"); // Awal arah kanan
  ...
  return (
    <div className="relative w-full py-4 overflow-hidden bg-transparent">
      ...
      <style jsx>{`
        ...
        .marquee-left {
          animation: marquee-left 20s linear infinite; /* Kecepatan lebih lambat */
        }

        .marquee-right {
          animation: marquee-right 20s linear infinite; /* Kecepatan lebih lambat */
        }
